...
cl -Fe.build\RedWheelbarrow.exe -nologo -W4 -WX -Z7 -Oi -J -EHa- -GR- -GS- -Gs0x10000000 -DDEBUG=1^
 platform\main_windows.cpp kernel32.lib user32.lib ws2_32.lib dwmapi.lib winmm.lib D3D11.lib d3dcompiler.lib^
...
) else if "%1"=="doc" ( start qrenderdoc .build\RedWheelbarrow.exe
